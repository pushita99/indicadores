...
MeasurementunitModule = __decorate([
    (0, common_1.Module)({
        controllers: [measurementunit_controller_1.MeasurementunitController],
        providers: [measurementunit_service_1.MeasurementunitService],
        imports: [typeorm_1.TypeOrmModule.forFeature([measurementunit_entity_1.Measurementunit])]
    })
