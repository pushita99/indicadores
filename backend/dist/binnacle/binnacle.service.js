...
exports.BinnacleService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const binnacle_entity_1 = require("./entities/binnacle.entity");
let BinnacleService = class BinnacleService {
    constructor(binnacleRepository) {
        this.binnacleRepository = binnacleRepository;
    }
    async create(createBinnacleDto) {
...
BinnacleService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(binnacle_entity_1.Binnacle)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], BinnacleService);
exports.BinnacleService = BinnacleService;
//# sourceMappingURL=binnacle.service.js.map